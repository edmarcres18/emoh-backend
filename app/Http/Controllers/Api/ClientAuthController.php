        ...
        try {
            ...
            $query = Rented::with([
                'property' => function ($query) {
                    $query->select('id', 'property_name', 'estimated_monthly', 'images', 'details', 'status', 'lot_area', 'floor_area', 'category_id', 'location_id');
                },
            ...
            // Search functionality - search in property name and rental notes
            ...
            // Update remarks for all rentals
